void select() {
    ...
    //psi(2S)
    //TFile *f_out = TFile::Open("DATA_XPSI_test4.root", "RECREATE");
    //TFile *f_out = TFile::Open("MC_PSI2S_test4.root", "RECREATE");
    TFile *f_out = TFile::Open("sideband_PSI_test4.root", "RECREATE");
