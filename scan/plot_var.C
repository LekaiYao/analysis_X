...
void plot_var() {
    // --------- 用户设置变量名 ---------
    //TString varName = "B_mass";  // 想要查看的变量名
    TString varName = "B_chi2cl";
    ...
    // 打开文件
    TFile *f_data = TFile::Open("/user/u/u25lekai/work/analysis_X/selection/root_files/DATA_XPSI_nonan.root");
    TFile *f_mc   = TFile::Open("/user/u/u25lekai/work/analysis_X/selection/root_files/MC_PSI2S.root");
    ...
    c1->SaveAs(varName + "_compare.pdf");
}
